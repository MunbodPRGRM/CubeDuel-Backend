...
/**
 * เข้าสู่ระบบด้วย Google/Facebook 30 ครั้ง / 15 นาที ต่อ IP — instance เดียวนับรวมทุก provider
 * และนับรวมขาไปกับขากลับ (ล็อกอินหนึ่งรอบ = 2 ครั้ง) · ไม่รู้ว่ามาจาก provider ไหน จึงไม่แนบ `provider` (ADR-070 ข้อ 5)
 * endpoint พวกนี้เป็นการ **เปิดหน้าเว็บ** → เกินเพดานแล้วต้องพากลับหน้าเข้าสู่ระบบพร้อมข้อความ
